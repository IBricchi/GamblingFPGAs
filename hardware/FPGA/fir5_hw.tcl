...
set_module_property NAME fir5
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME fir5
...
add_fileset_file CI_fir4.v VERILOG PATH verilog/CI_fir4.v TOP_LEVEL_FILE
add_fileset_file fir4.v VERILOG PATH verilog/fir4.v
...
add_interface_port nios_custom_instruction_slave dataa dataa Input 9
add_interface_port nios_custom_instruction_slave datab datab Input 2
...
add_interface_port conduit_end resultc firdata Output 32
