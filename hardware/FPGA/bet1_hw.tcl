...
set_module_property NAME bet1
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME bet1
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL CI_bet
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file CI_bet.v VERILOG PATH verilog/CI_bet.v TOP_LEVEL_FILE
add_fileset_file bet.v VERILOG PATH verilog/bet.v
...
add_interface_port conduit_end datac datac Input 6
