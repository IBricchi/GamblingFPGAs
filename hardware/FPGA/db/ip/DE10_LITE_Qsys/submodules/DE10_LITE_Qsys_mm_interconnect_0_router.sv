...
(
    ...
    localparam PAD10 = log2ceil(64'h4000092 - 64'h4000090); 
    localparam PAD11 = log2ceil(64'h4040000 - 64'h4020000); 
    localparam PAD12 = log2ceil(64'h4041000 - 64'h4040800); 
    localparam PAD13 = log2ceil(64'h4041020 - 64'h4041000); 
    localparam PAD14 = log2ceil(64'h4041030 - 64'h4041020); 
    localparam PAD15 = log2ceil(64'h4041040 - 64'h4041030); 
    localparam PAD16 = log2ceil(64'h4041048 - 64'h4041040); 
    localparam PAD17 = log2ceil(64'h4041050 - 64'h4041048); 
    // -------------------------------------------------------
    ...
    // ( 0x4000080 .. 0x4000090 )
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 27'h4000080  && read_transaction  ) begin
            src_channel = 18'b000000001000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 2;
    end

    // ( 0x4000090 .. 0x4000092 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 27'h4000090   ) begin
            src_channel = 18'b000000000000000001;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 0;
    end

    // ( 0x4020000 .. 0x4040000 )
    if ( {address[RG:PAD11],{PAD11{1'b0}}} == 27'h4020000   ) begin
            src_channel = 18'b000000000000100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 13;
    end

    // ( 0x4040800 .. 0x4041000 )
    if ( {address[RG:PAD12],{PAD12{1'b0}}} == 27'h4040800   ) begin
            src_channel = 18'b000000000000001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 12;
    end

    // ( 0x4041000 .. 0x4041020 )
    if ( {address[RG:PAD13],{PAD13{1'b0}}} == 27'h4041000   ) begin
            src_channel = 18'b000000000001000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 17;
    end

    // ( 0x4041020 .. 0x4041030 )
    if ( {address[RG:PAD14],{PAD14{1'b0}}} == 27'h4041020   ) begin
            src_channel = 18'b000000000100000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 10;
    end

    // ( 0x4041030 .. 0x4041040 )
    if ( {address[RG:PAD15],{PAD15{1'b0}}} == 27'h4041030   ) begin
            src_channel = 18'b000000000000010000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 1;
    end

    // ( 0x4041040 .. 0x4041048 )
    if ( {address[RG:PAD16],{PAD16{1'b0}}} == 27'h4041040   ) begin
            src_channel = 18'b000000000000000010;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 9;
    end

    // ( 0x4041048 .. 0x4041050 )
    if ( {address[RG:PAD17],{PAD17{1'b0}}} == 27'h4041048  && read_transaction  ) begin
